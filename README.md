...
```bash
wget https://github.com/icurfer/ic-bora-player/raw/main/dist/bora_0.19.0_all.deb
sudo apt install ./bora_0.19.0_all.deb
bora <영상파일>
```
...
| `←` `→` | 5초 탐색 | `P` | 핀 꽂고 제목 입력 |
| `↑` `↓` | 볼륨 | `Shift+P` | 핀 목록 |
| `F` `Esc` | 전체화면 | `K` | 이 구간을 클립으로 담기 |
| `[` `]` | 자막 싱크 ±0.1초 | `Shift+K` | 클립 목록 · 내보내기 |
